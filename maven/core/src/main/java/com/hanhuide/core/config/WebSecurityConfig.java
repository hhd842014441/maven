...
import com.hanhuide.core.filter.CustomFilterInvocationSecurityMetadataSource;
import com.hanhuide.core.filter.CustorObjectPostProcessor;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/kaptcha/render").permitAll().anyRequest().authenticated()
