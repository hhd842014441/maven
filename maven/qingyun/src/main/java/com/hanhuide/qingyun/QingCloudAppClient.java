...
import com.hanhuide.qingyun.domain.model.QingCloudAction;
...
import com.hanhuide.qingyun.ui.model.Request;
import com.hanhuide.qingyun.ui.model.Response;
...
public class QingCloudAppClient implements IQingCloudAppClient {
    ...
    public String decodeQingcloud(String data){
        ...
        try {
            decodeSignature = new String(Base64.decodeBase64(data), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
